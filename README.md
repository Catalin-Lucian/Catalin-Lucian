...
I’m a curious and driven **Software Engineer** specializing in **automation, scripting, CI/CD, and developer tooling**, with a strong background in **distributed systems and Linux-based environments**.  
...
<details>
<summary><strong>Senior Software Engineer – Continental (Apr 2024 – Present)</strong></summary>
...
<details>
<summary><strong>Software Engineering Intern – Continental (Dec 2021 – Jul 2022)</strong></summary>

- Contributed to internal tooling in a large enterprise environment  
- Developed a Unity-based runtime editor for reusable scene prefabs  
- Participated in Agile ceremonies and team collaboration  
- Gained exposure to CI workflows and enterprise-scale build systems  

</details>

<details>
<summary><strong>Summer Practice – Centric (Jan 2021 – Sep 2021)</strong></summary>
...
- **Computer Science & Engineering**: Data structures, algorithms, OS fundamentals, networking, software architecture  
- **Distributed Systems & Web Technologies**: Scalability, fault tolerance, web architectures, APIs  
...
[GitHub](https://github.com/Catalin-Lucian) | [Email](mailto:catalinlucian@proton.me) | [LinkedIn](https://www.linkedin.com/in/catalin-lucian/)
